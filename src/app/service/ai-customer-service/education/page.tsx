...
import { ArrowRight, XCircle, CheckCircle2, TrendingUp, Clock, Globe2, BookOpen } from "lucide-react";
...
const stats = [
  { value: "80%", label: "Admission inquiries handled by AI", icon: Clock },
  { value: "3x", label: "More enrollment conversions", icon: TrendingUp },
  { value: "24/7", label: "Available for international students", icon: Globe2 },
  { value: "2", label: "Languages supported natively", icon: BookOpen }
];

const problems = [
  {
    title: "Enrollment Season Chaos",
    desc: "During admission periods, your team is overwhelmed with inquiries about courses, fees, deadlines, and requirements."
  },
  {
    title: "Volume Spikes",
    desc: "Registration periods bring 5-10x normal inquiry volume. Response times drop and prospects lose interest."
  },
  {
    title: "International Students",
    desc: "Foreign students need English support at their timezone. Your team only works Vietnam hours in Vietnamese."
  }
];

const process = [
  { num: "01", title: "Admissions Information", desc: "Hubi answers questions about programs, fees, schedules, prerequisites, and campus facilities — instantly and accurately." },
  { num: "02", title: "Course Recommendations", desc: "Based on student background and interests, Hubi recommends the best programs and learning paths." },
  { num: "03", title: "Enrollment Guidance", desc: "Walk students through the registration process step by step — required documents, deadlines, and payment methods." },
  { num: "04", title: "Bilingual Support", desc: "Native Vietnamese and English support. Auto-detects language and responds accordingly — no separate bot needed." }
];

const benefits = [
  "80% of admission inquiries handled without human staff",
  "3x more enrollment conversions from faster response times",
  "24/7 availability for international student inquiries",
  "Seamless Vietnamese and English support from one bot"
];

export default function EducationHubiPage() {
  ...
  return (
    <div ref={containerRef} className="min-h-screen bg-background text-foreground selection:bg-blue-500/30 font-sans">
      ...
      <section className="relative pt-32 pb-20 md:pt-40 md:pb-24 px-6 lg:px-8 max-w-[1400px] mx-auto">
        ...
        <div className="max-w-4xl">
          ...
          <h2 className="reveal-text text-xl md:text-2xl font-serif text-zinc-400 leading-relaxed max-w-3xl mb-10">
            Prospective students have questions at all hours — course details, fees, schedules, admission requirements. Hubi handles it all in Vietnamese and English, turning inquiries into enrollments.
          </h2>
      ...
      <section className="py-24 px-6 lg:px-8 max-w-[1400px] mx-auto border-t border-zinc-900">
        ...
        <p className="text-zinc-400 text-center mb-16">Workflow for Education</p>
