...
import { ArrowRight, XCircle, CheckCircle2, TrendingUp, Clock, Zap, Ticket } from "lucide-react";
...
const stats = [
  { value: "90%", label: "Booking inquiries handled by AI", icon: Zap },
  { value: "0", label: "Double-booking errors", icon: CheckCircle2 },
  { value: "24/7", label: "Ticket sales never stop", icon: Clock },
  { value: "3x", label: "More after-hours sales", icon: TrendingUp }
];

const problems = [
  {
    title: "Pre-Event Hotline Chaos",
    desc: "Days before an event, your phone lines are jammed. Customers can't get through to ask about seats, timing, or parking."
  },
  {
    title: "Manual Booking Errors",
    desc: "Spreadsheet-based or manual booking leads to double-sells, wrong seat assignments, and angry customers."
  },
  {
    title: "After-Hours Lost Sales",
    desc: "Impulse buyers discover your event at night but can't book. By morning, they've forgotten or found alternatives."
  }
];

const process = [
  { num: "01", title: "Live Seat Availability", desc: "Hubi shows available seats, sections, and pricing in real-time — customers pick and book instantly." },
  { num: "02", title: "Instant Ticket Purchase", desc: "Complete booking flow through chat — seat selection, payment link, and confirmation in under 2 minutes." },
  { num: "03", title: "E-Ticket Delivery", desc: "Tickets sent instantly via chat, email, or SMS with QR codes — no waiting for manual processing." },
  { num: "04", title: "Event FAQ Auto-Response", desc: "Parking, dress code, age restrictions, lineup — Hubi handles all event-related questions without human staff." }
];

const benefits = [
  "90% of booking inquiries handled without human intervention",
  "Zero double-booking errors with real-time inventory sync",
  "3x more after-hours ticket sales",
  "Staff freed up to focus on event operations, not phone duty"
];

export default function TicketsHubiPage() {
  ...
  return (
    <div ref={containerRef} className="min-h-screen bg-background text-foreground selection:bg-blue-500/30 font-sans">
      ...
      <section className="relative pt-32 pb-20 md:pt-40 md:pb-24 px-6 lg:px-8 max-w-[1400px] mx-auto">
        ...
        <div className="max-w-4xl">
          ...
          <h1 className="reveal-text text-5xl md:text-7xl font-serif font-medium tracking-tighter leading-[1.05] mb-8 text-foreground">
            Hubi for Ticket & Events
          </h1>
          <h2 className="reveal-text text-xl md:text-2xl font-serif text-zinc-400 leading-relaxed max-w-3xl mb-10">
            Events sell out fast, and so does customer patience. Hubi shows seat availability, handles purchases, sends e-tickets, and answers event details — even at 2 AM when the box office is closed.
          </h2>
      ...
      <section className="py-24 px-6 lg:px-8 max-w-[1400px] mx-auto border-t border-zinc-900">
        ...
        <p className="text-zinc-400 text-center mb-16">Workflow for Ticket & Events</p>
