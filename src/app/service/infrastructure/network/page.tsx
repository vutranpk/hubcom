...
import { ArrowRight, Wifi, XCircle, CheckCircle2, ChevronRight, BarChart3, Clock, Users, ShieldCheck } from "lucide-react";
...
const stats = [
  { value: "99.9%", label: "Guaranteed uptime", icon: BarChart3 },
  { value: "3-5", label: "Days to complete", icon: Clock },
  { value: "50+", label: "Projects deployed", icon: Users },
  { value: "24/7", label: "Technical support", icon: ShieldCheck }
];

const problems = [
  "WiFi keeps dropping, losing connection mid-work",
  "Zoom, Google Meet calls constantly freezing",
  "Staff complaining about slow internet every day",
  "No visibility into who's using bandwidth"
];

const process = [
  { num: "01", title: "Free site survey", desc: "Assess current state, measure signal, identify needs" },
  { num: "02", title: "Solution design", desc: "Detailed blueprint, quote within 24h" },
  { num: "03", title: "Professional installation", desc: "Certified team, neat work, on schedule" },
  { num: "04", title: "Handover & support", desc: "Full testing, user training, 12-month warranty" }
];

const benefits = [
  "Fast & stable network - no more lag or disconnections",
  "Full WiFi coverage - from meeting rooms to warehouses",
  "Safe & separate - staff, guest, device networks isolated",
  "Easy to manage - change WiFi password in 1 minute",
  "Delivered in 3-5 days with complete documentation"
];

const whyUs = [
  "Team certified by Cisco, Ubiquiti, Aruba",
  "99.9% uptime guaranteed by contract",
  "12-24 month warranty depending on package",
  "24/7 remote support after handover"
];

const cases = [
  { target: "Office with 50+ staff", before: "Unstable WiFi, Zoom calls freezing", after: "99.9% uptime, smooth video calls" },
  { target: "F&B chain with 5 locations", before: "Can't manage WiFi across branches", after: "Single dashboard control, save $150/month" },
  { target: "Manufacturing warehouse", before: "No signal in warehouse, barcode scanners disconnecting", after: "Full coverage, 25% productivity increase" }
];
      ...
      <section className="relative pt-32 pb-20 md:pt-40 md:pb-24 px-6 lg:px-8 max-w-[1400px] mx-auto">
        ...
        <div className="max-w-4xl">
          ...
          <h2 className="reveal-text text-2xl md:text-3xl font-serif text-zinc-300 font-medium mb-6">
            Slow internet? Video calls keep freezing?
          </h2>
          <p className="reveal-text text-lg md:text-xl text-zinc-400 max-w-3xl leading-relaxed mb-10">
            We handle everything: survey → installation → stable delivery
          </p>
