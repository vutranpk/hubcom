...
import { ArrowRight, Wrench, XCircle, CheckCircle2, ChevronRight, Clock, ShieldCheck, PiggyBank, HeartHandshake } from "lucide-react";
...
const stats = [
  { value: "15'", label: "Response time", icon: Clock },
  { value: "70%", label: "IT cost savings", icon: PiggyBank },
  { value: "99.5%", label: "Same-day resolution", icon: HeartHandshake },
  { value: "0", label: "Virus incidents in 12 months", icon: ShieldCheck }
];

const problems = [
  "Equipment breaks, don't know who to call, wait 2-3 days",
  "Hit by virus, ransomware, lost all data",
  "Hiring full-time IT costs $800-1000/month but not enough work",
  "No one backing up data, scared of losing everything"
];

const process = [
  { num: "01", title: "Current state assessment", desc: "Check systems, identify risks and needs" },
  { num: "02", title: "Package recommendation", desc: "Basic package from $200, based on company size" },
  { num: "03", title: "Security deployment", desc: "Install antivirus, backup, remote monitoring" },
  { num: "04", title: "Continuous support", desc: "24/7 hotline, on-site tech within 2 hours" }
];

const benefits = [
  "Fast response - support within 15 minutes",
  "On-site help - complex issues? Technician comes to you",
  "24/7 availability - midnight or weekend, we're on call",
  "Prevention over cure - regular checks catch issues early",
  "Save money - no need for full-time IT staff"
];

const whyUs = [
  "Response within 15 minutes via hotline",
  "On-site technician within 2 hours",
  "Daily data backup to cloud",
  "Monthly system status reports"
];

const cases = [
  { target: "Trading company with 30 staff", before: "No IT dept, broken equipment waits 2-3 days", after: "Same-day fixes, save $500/month" },
  { target: "Private clinic", before: "Software crashes often, worried about patient data", after: "6 months zero downtime, 100% data safe" },
  { target: "Marketing agency", before: "Staff installing pirated software, virus infections", after: "Zero viruses, client data secured" }
];
